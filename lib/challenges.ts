...
export type TrackId = 'rtl' | 'cdc' | 'timing' | 'soc' | 'verification' | 'ppa' | 'dram' | 'hbm' | 'lpddr-gddr' | 'pcie';
...
export const tracks: { id: TrackId; label: Localized; accent: string }[] = [
  ...
  { id: 'dram', label: { zh: 'DRAM Controller', en: 'DRAM Controller' }, accent: 'bg-lime-500' },
  { id: 'hbm', label: { zh: 'HBM Controller', en: 'HBM Controller' }, accent: 'bg-sky-500' },
  { id: 'lpddr-gddr', label: { zh: 'LPDDR / GDDR', en: 'LPDDR / GDDR' }, accent: 'bg-fuchsia-500' },
  { id: 'pcie', label: { zh: 'PCIe Controller', en: 'PCIe Controller' }, accent: 'bg-orange-500' },
];
